...
<template>
    ...
    <div class="container">
        ...
        <div class="left-section">
            <img src="@/assets/1.png" alt="Logo" class="logo" style="width: 500px;">
        ...
        <div class="right-section">
            <div class="login-box">
                ...
                <form>
                    ...
                    <a href="http://localhost:5173/phoneforget" class="forgot-password">忘记密码</a>
                    <button type="primary" @click.prevent="toHome">登录</button>
                </form>
            </div>
        </div>
    </div>
